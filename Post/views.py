...
me = User.objects.get(username='pavan')
...
def newsfeed(request):
    ...
    # searched keyword is '#pavan'

    if hashtag_string == '#pavan':
        url_list = []
        retweet_count_list = []
        url_retweet_dict = {}
        url_favorite_dict = {}
    ...
    # get the images of particular hashtag
        ...
        '''
            ...
            User.objects.get(username='pavan').delete()
        '''
        ...
        for url in new_urls:
            album = Album(hashtag = hashtag_string, image_url = url, user = me, retweet_count = url_retweet_dict[url], like_count = url_favorite_dict[url], emotion = 'happiness')
            album.save()
